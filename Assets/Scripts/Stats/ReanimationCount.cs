[System.Serializable]
public class ReanimationCount : Stat
{
    public ReanimationCount(StatData statData, UpgradeList upgradeList = null, bool isDebug = false) : base(statData, upgradeList, isDebug)
    {
