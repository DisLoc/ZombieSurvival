[System.Serializable]
public class AbilityChooseCount : Stat
{
    public AbilityChooseCount(StatData statData, UpgradeList upgradeList = null, bool isDebug = false) : base(statData, upgradeList, isDebug)
    {
